...
class VentaAccessService
{
    public function autorizarOperacion(User $actor, Reposteria $reposteria): void
    {
        ...
        throw new AuthorizationException('No tiene autorización para operar ventas de esta repostería.');
    }
