...
Route::middleware(['auth:sanctum', 'active'])->group(function () {
    ...
    Route::prefix('v1')->group(function () {
        ...
        Route::get('/reposterias/{reposteria}/dashboard', DashboardController::class);
        Route::get('/reposterias/{reposteria}/reportes/ventas', [ReporteController::class, 'ventas']);
        Route::get('/reposterias/{reposteria}/reportes/pedidos', [ReporteController::class, 'pedidos']);
        Route::get('/reposterias/{reposteria}/reportes/inventario', [ReporteController::class, 'inventario']);
